...
These are tasks that must be completed by the user (not the agent) before Phase 2 implementation begins. Each file contains a walkthrough for one prerequisite.
